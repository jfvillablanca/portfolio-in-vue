  ...
  <generic-panel>
    <div class="flex flex-col mb-5">
      <h1 class="text-xl md:text-3xl mb-5">
        ...
        <i class="las la-icons text-primary" />
      </h1>
      <p class="md:text-lg">
        Get more icons from the
        <a
          class="text-primary"
          href="https://icons8.com/line-awesome"
          target="_blank"
        >
          Line Awesome documentation
        </a>
        .
      </p>
    </div>
    <div class="flex space-x-5 overflow-scroll">
      <i class="las la-cat text-4xl" />
      <i class="las la-crow text-4xl" />
      <i class="las la-dog text-4xl" />
      <i class="las la-dove text-4xl" />
      <i class="las la-horse text-4xl" />
      <i class="las la-spider text-4xl" />
      <i class="las la-kiwi-bird text-4xl" />
      <i class="las la-beer text-4xl" />
      <i class="las la-glass-whiskey text-4xl" />
      <i class="las la-home text-4xl" />
      <i class="las la-birthday-cake text-4xl" />
      <a
        class="hidden md:inline text-lg mt-1 text-primary"
        href="https://icons8.com/line-awesome"
        target="_blank"
      >
        and more...
    ...
    <a
      class="inline md:hidden text-lg mt-1 text-primary"
      href="https://icons8.com/line-awesome"
      target="_blank"
    >
      and more...
    ...
    <div class="flex flex-col">
      ...
      >
        <div
          data-aos="fade-down"
          data-aos-delay="500"
          class="w-full md:w-[200px] h-[200px] bg-green-200"
        />
        <div
          data-aos="flip-left"
          data-aos-delay="1000"
          class="w-full md:w-[200px] h-[200px] bg-red-200"
        />
        <div
          data-aos="zoom-in"
          data-aos-delay="1500"
          class="w-full md:w-[200px] h-[200px] bg-blue-200"
        />
        <a
          class="text-lg mt-1 text-primary"
